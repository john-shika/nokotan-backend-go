...
func NewEncodeBase64(data []byte) string {
	return base64.StdEncoding.EncodeToString(data)
}

func NewEncodeBase64URLSafe(data []byte) string {
	return base64.RawURLEncoding.EncodeToString(data)
}

func NewDecodeBase64(data string) ([]byte, error) {
	return base64.StdEncoding.DecodeString(data)
}

func NewDecodeBase64URLSafe(data string) ([]byte, error) {
