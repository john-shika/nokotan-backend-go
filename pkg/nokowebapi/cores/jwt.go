...
func (claims *JwtClaims) GetIdentity() (string, error) {
	return claims.ParseString(string(JwtClaimIdentity))
}

func (claims *JwtClaims) SetIdentity(identity string) bool {
	return claims.Set(string(JwtClaimIdentity), identity)
}

func (claims *JwtClaims) GetSubject() (string, error) {
	return claims.ParseString(string(JwtClaimSubject))
}

func (claims *JwtClaims) SetSubject(subject string) bool {
	return claims.Set(string(JwtClaimSubject), subject)
}
...
func (claims *JwtClaims) GetIssued() (*jwt.NumericDate, error) {
	...
	temp, err = claims.ParseNumericDate(string(JwtClaimIssuedAt))
	return temp, err
}

func (claims *JwtClaims) SetIssuedAt(date any) bool {
	return claims.Set(string(JwtClaimIssuedAt), GetJwtNumericDateFromAny(date))
}

func (claims *JwtClaims) GetIssuer() (string, error) {
	return claims.ParseString(string(JwtClaimIssuer))
}

func (claims *JwtClaims) SetIssuer(issuer string) bool {
	return claims.Set(string(JwtClaimIssuer), issuer)
}

func (claims *JwtClaims) GetAudience() ([]string, error) {
	return claims.ParseStringMany(string(JwtClaimAudience))
}

func (claims *JwtClaims) SetAudience(audience []string) bool {
	return claims.Set(string(JwtClaimAudience), audience)
}
...
func (claims *JwtClaims) GetExpires() (*jwt.NumericDate, error) {
	...
	temp, err = claims.ParseNumericDate(string(JwtClaimExpiresAt))
	return temp, err
}

func (claims *JwtClaims) SetExpiresAt(date any) bool {
	return claims.Set(string(JwtClaimExpiresAt), GetJwtNumericDateFromAny(date))
}

func (claims *JwtClaims) GetSessionId() (string, error) {
	return claims.ParseString(string(JwtClaimSessionId))
}

func (claims *JwtClaims) SetSessionId(sessionId string) bool {
	return claims.Set(string(JwtClaimSessionId), sessionId)
}

func (claims *JwtClaims) GetUser() (string, error) {
	return claims.ParseString(string(JwtClaimUser))
}

func (claims *JwtClaims) SetUser(user string) bool {
	return claims.Set(string(JwtClaimUser), user)
}

func (claims *JwtClaims) GetRole() (string, error) {
	return claims.ParseString(string(JwtClaimRole))
}

func (claims *JwtClaims) SetRole(role string) bool {
	return claims.Set(string(JwtClaimRole), role)
}

func (claims *JwtClaims) GetEmail() (string, error) {
	return claims.ParseString(string(JwtClaimEmail))
}

func (claims *JwtClaims) SetEmail(email string) bool {
	return claims.Set(string(JwtClaimEmail), email)
}

func (claims *JwtClaims) GetPhone() (string, error) {
	return claims.ParseString(string(JwtClaimPhone))
}

func (claims *JwtClaims) SetPhone(phone string) bool {
	return claims.Set(string(JwtClaimPhone), phone)
}
